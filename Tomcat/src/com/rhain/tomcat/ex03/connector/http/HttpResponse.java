...
import com.rhain.tomcat.ex03.connector.ResponseStream;
import com.rhain.tomcat.ex03.connector.ResponseWriter;
...
public class HttpResponse implements HttpServletResponse {
  ...
  /**
   * Send the HTTP response headers, if this has not already occurred. 发送http 响应头
   */
...
*/
  ...
  /* This method is used to serve a static page 处理静态页面*/
