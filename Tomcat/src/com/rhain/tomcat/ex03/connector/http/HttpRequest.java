...
import com.rhain.tomcat.ex03.connector.RequestStream;
...
public class HttpRequest implements HttpServletRequest {
  ...
  /**
   * The request attributes for this request.request中的参数
   */
  ...
  /**
   * Parse the parameters of this request, if it has not already occurred.如果没有参数没有解析过，则解析参数
